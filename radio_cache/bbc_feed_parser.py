...
targets the publicly accessible ``/v2/programmes/playable`` endpoint
...
def fetch_drama_programmes(
    ...
    Iterates through category listings using the ``/v2/programmes/playable``
    endpoint with offset-based pagination.  Respects rate limits by
